...
const HomePage: React.FC = () => {
  ...
  <div
    className={`relative w-full flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-[16px] justify-start items-center bg-global-background5 border border-global-text2 rounded-[30px] p-8 sm:p-10 md:p-12 lg:p-[46px] overflow-hidden transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl cursor-pointer ${
  ...
  >
    ...
    <Image
      ...
      width={260}
      height={260}
      className="pointer-events-none select-none absolute right-0 top-1/2 -translate-y-1/2 z-0 w-[150px] h-[150px] sm:w-[190px] sm:h-[190px] md:w-[230px] md:h-[230px] lg:w-[250px] lg:h-[250px]"
    ...
    <div className="relative z-10 w-full flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-[14px] justify-start items-start">
      ...
      <div className="flex flex-row justify-start items-center gap-2 sm:gap-3 md:gap-4 lg:gap-[10px] mt-8 sm:mt-10 md:mt-12 lg:mt-[48px]">
        <Image
...
<Link href="/Launchpad" className="block">
  <div
    className={`relative w-full flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-[16px] justify-start items-center bg-global-background1 border border-global-text2 rounded-[30px] p-8 sm:p-10 md:p-12 lg:p-[46px] overflow-hidden transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl cursor-pointer ${
      visibleSections.has('what-we-offer')
  ...
  <div
    className={`relative w-full flex flex-col justify-start items-center bg-[#f45b6a] border border-global-text2 rounded-[30px] p-8 sm:p-10 md:p-12 lg:p-[46px] shadow-[0px_5px_1px_#000000] overflow-hidden transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl cursor-pointer ${
      visibleSections.has('what-we-offer')
  ...
  <div
    className={`relative w-full flex flex-col justify-start items-center bg-global-background5 border border-global-text2 rounded-[30px] p-8 sm:p-10 md:p-12 lg:p-[46px] shadow-[0px_5px_1px_#000000] overflow-hidden transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl cursor-pointer ${
      visibleSections.has('what-we-offer')
