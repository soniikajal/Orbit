...
const AcademicCalendarPage: React.FC = () => {
  ...
  const handleNotifySubmit = (e: React.FormEvent) => {
    ...
    if (notifyEmail) {
      ...
      console.log('Email submitted for Academic Calendar notifications:', notifyEmail);
      
      // Reset email after 3 seconds for demo purposes
      setTimeout(() => {
        setNotifyEmail(session?.user?.email || '');
      }, 3000);
    }
              ...
              <div className="w-full max-w-md mx-auto mb-8">
                {!subscribed ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-global-5 font-space-grotesk">We'll notify you when the Academic Calendar is ready!</p>
                  </div>
                )}
              </div>
